...
- кнопки **«💬 Оставить фидбэк»** и **«✅ Взял в работу»**.

### Кнопка «Взял в работу»

Нажимает тот, кто реально берёт компанию, — любой участник команды, не только тот,
на кого она заведена. После нажатия:
- у всех в команде кнопка гаснет и превращается в подпись «В работе: Имя»;
- остальным участникам приходит сообщение «✅ Взято в работу» — ответом (цитатой)
  на их уведомление об этой компании, с именем и временем;
- в интерфейсе контура напротив компании появляется «взял: Имя, время».

Если кто-то уже нажал — вместо взятия покажется, кто и когда взял. Перехватить компанию
кнопкой нельзя. Статус в СРМ кнопка не меняет — его по-прежнему ставите в Аргусе.
